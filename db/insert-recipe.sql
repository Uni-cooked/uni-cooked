...
("Caprese","pendolare","primo",5,"Piatto semplice, utile per giornate mhe","2024-12-28","../asset/img/recipe/default.jpg",5);

INSERT INTO Ingrediente(nome) VALUES ("pomodori da insalata"), ("mozzarelle"), ("origano");
...
INSERT INTO Preparazione(numero,ricetta,descrizione) VALUES (1,"Riso Venere con verdure","Riempi una pentola di acqua e falla bollire, poi butta del sale grosso e il riso. Cuoci a fuoco medio-alto per il tempo indicato sulla confezione mescolando ogni tanto."), (2,"Riso Venere con verdure","Nel mentre pela la carota e tagliala e striscioline, mettile in padella con un filo d'olio, un po' di acqua e un pizzico di sale fino. Accendi il fuoco basso e copri con un coperchio, le carote ci mettono un pochino di più a cucinarsi."), (3,"Riso Venere con verdure","Senza perdere tempo che per noi studenti è prezioso lava la zucchina e tagliala a rondelle o pezzetti piccoli (fa' un po' come ti pare). Aggiungila alle carote nella padella con un pizzico di sale. Ogni tanto girale e aggiungi un po' d'acqua se vedi che è evaporata per non farle attaccare alla padella. Cucina a fuoco medio-basso per circa 8-10 minuti."), (4,"Riso Venere con verdure", "Occhio al riso."), (5,"Riso Venere con verdure","Lava i pomodorini e tagliali a piccoli spicchi."),(6,"Riso Venere con verdure","Se pensi di riuscire a finire tutto questo bel piattone apri anche una scatola di mais e scolala così da avere tutto pronto sul tavolo."), (7,"Riso Venere con verdure","Quando il riso, le zucchine e le carote sono pronte versa tutto in un piatto insieme ai pomodorini e il mais. Condisci con un filo d'olio e assapora il gusto di chi può permettersi certe prelibatezze.");
