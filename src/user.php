...
if (!isset($_GET["username"])) {
    ...
    $paginaHtml = str_replace("{{sign-out-form}}", '<form action="./sign-out.php" method="post"><button id="log-out" type="submit" name="sign-out" value="true">ESCI</button></form>', $paginaHtml);
